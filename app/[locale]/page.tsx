...
export default function Home() {
  ...
  const socials = [
    { label: t("footer.facebook"), href: "https://www.facebook.com/" },
    { label: t("footer.instagram"), href: "https://www.instagram.com/ttmagency.ok/" },
    { label: t("footer.whatsapp"), href: "https://wa.me/5491171410652" },
  ];
  ...
  return (
    <>
      ...
      <section className="relative w-full overflow-hidden bg-[var(--brand-accent)] flex flex-col md:flex-row items-stretch pt-16 min-h-[85vh]">
        {/* Left: text */}
        <div
          className="relative z-20 flex flex-col justify-center gap-5 py-16 md:py-0 md:w-[55%] lg:w-[58%]"
          style={{
        ...
        {/* Right: video */}
        <div className="relative md:w-[45%] lg:w-[42%] min-h-[45vh] md:min-h-0">
          <video
      ...
      <footer className="bg-[var(--brand-text-primary)] py-12 px-6 text-center flex flex-col items-center gap-6">
        ...
        <p className="text-white/40 text-sm uppercase tracking-widest">
          © {new Date().getFullYear()} TTM Agencia — {t("footer.rights")}
        </p>
      </footer>
    </>
  );
